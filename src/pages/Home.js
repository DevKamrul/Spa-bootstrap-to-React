                ...
                <div className="container py-md-5">
                    ...
                    <div className="info-w3pvt-mid text-center px-lg-5">
                        <div className="title-desc text-center px-lg-5">
                            <img src="assets/images/about1.png" alt="news" className="img-fluid" />
                            ...
                            <Link className="btn mt-lg-4 mt-3 read scroll" to="#services" role="button">Learn More</Link>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="container py-md-5">
                    ...
                    <div className="row ab-info">
                        <div className="col-md-6 ab-content ab-content1">
                            <div className="ab-content-inner">
                                <Link to="single.html"><img src="assets/images/services2.jpg" alt="news" className="img-fluid" /></Link>
                        ...
                        <div className="col-md-6 ab-content ab-content1">
                            <div className="ab-content-inner">
                                <Link to="single.html"><img src="assets/images/services1.jpg" alt="news" className="img-fluid" /></Link>
                                <div className="ab-info-con">
                    ...
                    <div className="row ab-info second mt-lg-4">
                        <div className="col-md-3 ab-content">
                            <div className="ab-content-inner">
                                <Link to="single.html"><img src="assets/images/ser3.jpg" alt="news" className="img-fluid" /></Link>
                                <div className="ab-info-con">
                                    <h4>colouring</h4>
                                    <Link to="/single" className="read-more two btn m-0 px-3"><span className="fa fa-arrow-circle-o-right"> </span></Link>
                                </div>
                        ...
                        <div className="col-md-3 ab-content">
                            <div className="ab-content-inner">
                                <Link to="single.html"><img src="assets/images/ser4.jpg" alt="news" className="img-fluid" /></Link>
                                <div className="ab-info-con">
                                    <h4>Bathing</h4>
                                    <Link to="/single" className="read-more two btn m-0 px-3"><span className="fa fa-arrow-circle-o-right"> </span></Link>
                                </div>
                        ...
                        <div className="col-md-3 ab-content">
                            <div className="ab-content-inner">
                                <Link to="/single"><img src="assets/images/ser5.jpg" alt="news" className="img-fluid" /></Link>
                                <div className="ab-info-con">
                                    <h4>drying</h4>
                                    <Link to="/single" className="read-more two btn m-0 px-3"><span className="fa fa-arrow-circle-o-right"> </span></Link>
                                </div>
                        ...
                        <div className="col-md-3 ab-content">
                            <div className="ab-content-inner">
                                <Link to="/single"><img src="assets/images/ser6.jpg" alt="news" className="img-fluid" /></Link>
                                <div className="ab-info-con">
                                    <h4>Creams</h4>
                                    <Link to="/single" className="read-more two btn m-0 px-3"><span className="fa fa-arrow-circle-o-right"> </span></Link>
                                </div>
                ...
                <div className="container py-md-5">
                    <div className="test-info text-center">
                        ...
                        <div className="read-more mx-auto m-0 text-center">
                            <Link to="/contact" className="read-more scroll btn">Click here</Link>  </div>
                    </div>
                </div>
            </section>
